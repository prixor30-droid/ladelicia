...
[data-testid="stButton-btn_produccion"] button,[data-testid="stButton-btn_carro"] button,[data-testid="stButton-btn_fabrica"] button,[data-testid="stButton-btn_resumen"] button{background:#FFFFFF !important;color:#1A0A12 !important;-webkit-text-fill-color:#1A0A12 !important;box-shadow:0 2px 10px rgba(216,27,122,0.15) !important;min-height:84px !important;border-radius:16px !important;}
