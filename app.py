...
.brand-logo img{height:620px !important;margin-bottom:0 !important;animation:logoBounce 2.5s ease-in-out infinite;}
...
@keyframes logoBounce{0%,20%,50%,80%,100%{transform:translateY(0);}40%{transform:translateY(-14px);}60%{transform:translateY(-7px);}}
